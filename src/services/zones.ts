...
export const DETECTION_ZONES: DetectionZone[] = [
  ...
  },
  {
    ...
    type: 'INNER',
    polygon: [
      [51.4753, -0.4930], [51.4753, -0.4888],
      [51.4735, -0.4888], [51.4735, -0.4930],
    ],
  },
  {
  ...
  },
  {
    ...
    lat: 51.5032, lng: 0.0532, radiusKm: 0.18,
    fee: 8, penaltyFee: 80,
    payUrl: 'https://www.londoncityairport.com',
    type: 'INNER',
    polygon: [
      [51.5041, 0.0507], [51.5041, 0.0557],
      [51.5023, 0.0557], [51.5023, 0.0507],
    ],
  },
];
