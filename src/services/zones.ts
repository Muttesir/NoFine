...
// ─── Detection zones (precise terminal-level, used only for GPS drop-off detection) ─
export const DETECTION_ZONES: DetectionZone[] = [
  ...
  { id: 'gatwick_north',name: 'Gatwick North', lat: 51.1618, lng: -0.1762, radiusKm: 0.20, fee: 10, penaltyFee: 100, payUrl: 'https://www.gatwickairport.com/transport-options/drop-off',        type: 'INNER' },
  { id: 'gatwick_south',name: 'Gatwick South', lat: 51.1565, lng: -0.1595, radiusKm: 0.20, fee: 10, penaltyFee: 100, payUrl: 'https://www.gatwickairport.com/transport-options/drop-off',        type: 'INNER' },
